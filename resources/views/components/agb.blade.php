{{-- Allgemeine Geschaeftsbedingungen - zentral gepflegt in immowert/legal.

     Der Vertragstext ist unveraendert aus der bisherigen Fassung uebernommen
     (Status/Aktualisierung am Ende des Textes); ersetzt sind ausschliesslich
     die Firmendaten, die jetzt aus config('immowert-legal.company') kommen.
     Aenderungen am Vertragstext gehoeren in dieses Paket, nicht in ein Portal. --}}
@php($c = (array) config('immowert-legal.company'))

<p align="justify">Nutzungsbedingungen für die Besteller für die bereitgestellten Onlineinhalte.<br>
    ...
    Informationen
    im Zusammenhang mit der Website verstanden worden und anerkannt werden.<br /><br />
    ...
    Nutzer pro E-Mail-Adresse verwendet werden.<br /><br />
    ...
    gebracht.<br /><br />
    Dem Besteller ist es untersagt, Werbung in Bewertungskommentaren zu betreiben.<br /><br />
    <b>Vertragsabschluss</b><br>
    ...
    versendet.<br /><br />
    <b>Missbrauch</b><br>
    Sämtliche Missbräuche des Bestellportals werden gerichtlich verfolgt.<br /><br />
    <b>Beschwerden und Mängelhaftung</b><br>
    ...
    display/ ).<br /><br />
    <b>Vertragsdurchführung</b><br>
    Allgemeine Geschäftsbedingungen und Verbraucherinformationen im Rahmen von Verträgen, die zwischen
    der
    Websitebetreiberin {{ $c['name'] }},
    {{ $c['street'] }}, {{ $c['postal_code'] }} {{ $c['city'] }} - im Folgenden „Anbieter“ - und dem Kunden - im Folgenden „Kunde“
    -
    ...
    <b>§ 1 Geltungsbereich und allgemeine Hinweise</b>
    <br>
    ...
    <b>§ 3 Vertragsgegenstand, Mitwirkungspflichten des Kunden</b>
    <br>
    ...
    <b>§ 6 Zahlungs- und Leistungsbedingungen</b>
    <br>
    ...
    <b>§ 7 Gewährleistung und Haftung</b>
    <br>
    ...
    (2) Um das Widerrufsrecht auszuüben, muss der Kunde dem Anbieter ({{ $c['name'] }}, {{ $c['street'] }}, {{ $c['postal_code'] }} {{ $c['city'] }}, Fax: {{ $c['fax'] }},
    <a href ="https://direktantrag.com/helpcenter/customer/display/" target="_blank">Servicedienstleister
        über Storno infomieren</a>) mittels eindeutiger Erklärung (z.B. ein mit der Post versandter
    Brief,
    ...
    <b>Hinweise und Informationen zur elektronische Signatur, eSignatur</b><br>
    (1) Zusammenfassung der Legalität der elektronischen Signatur<br>
    ...
    elektronische
    Form ersetzt werden kann, es sei denn, das Gesetz führt zu einem anderen Schluss.<br><br>
    (2) Arten der elektronischen Signatur<br>
    ...
    elektronischen Signatur" (QES).<br><br>
    ...
    Unterzeichnung verwendet werden (Artikel 3.10 eIDAS).<br><br>
    ...
    schriftlichen
    Signatur anerkannt wird (Artikel 25.2 eIDAS).<br><br>
    Das deutsche Recht definiert keine elektronische Signatur, die von eIDAS unabhängig ist.<br><br>
    (3) Dokumente, die elektronisch signiert werden können<br>
    ...
    Regierungsanmeldungen<br><br>
    (4) Weitere Anleitung<br>
    ...
    belegen,
    dass die Erklärung nicht mit dem Willen des Unterschriftenschlüsselinhabers abgegeben wurde.<br><br>
    ...
    Gleiches gilt für eventuelle Regelungslücken.<br><br>Status und Aktualisierung: online seit
    2020-06-09,
